(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-testimon__slider")) new core(".slider-testimon__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrow-testimon__prev",
                    nextEl: ".arrow-testimon__next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        var errorMap = [ "Zlé číslo", "Invalid country code", "Príliš krátky", "Príliš dlho", "Zlé číslo" ];
        ...
        var script_reset = function() {
            input.classList.remove("error");
            errorMsg.innerHTML = "";
            errorMsg.classList.add("hide");
            validMsg.classList.add("hide");
        };
        const odoslatButton = document.getElementById("odoslat");
        input.addEventListener("keyup", (function() {
            script_reset();
            if (input.value.trim()) if (iti.isValidNumber()) {
                validMsg.classList.remove("hide");
                odoslatButton.disabled = false;
            } else {
